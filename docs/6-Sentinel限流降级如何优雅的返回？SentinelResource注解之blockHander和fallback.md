# 6-Sentinel限流降级如何优雅的返回？SentinelResource注解之blockHander和fallback
...
本篇文章填上次 [将 Sentinel 熔断限流规则持久化到 Nacos 配置中心](https://mp.weixin.qq.com/s/ua6OA2IWHuHGZUc01rqrvA) 提到的一个问题：之前我们访问接口进行限流或者降级后，直接返回500错误，或者提示 `flow limit` 之类的东西：
...
![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/72563d2242cf440da7b9db5df26c4636~tplv-k3u1fbpfcp-watermark.image?)
