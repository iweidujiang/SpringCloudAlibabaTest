...
书接前文：[服务容错的必要性与Spring Cloud Alibaba Sentinel 限流配置实战](https://mp.weixin.qq.com/s/ZzKPhpjCfBNTI1AXnM5Zig) ，本文主要介绍 `Sentinel` 的熔断降级。
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4b732c0735b74d1a82c4c4accf452ee8~tplv-k3u1fbpfcp-zoom-1.image)
